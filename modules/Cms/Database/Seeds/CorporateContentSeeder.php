            ...
            'sections' => [
                    ...
                    ['values_grid', [
                        ...
                        'items' => [
                            ...
                            ['title' => $this->loc('Entrepreneurial Spirit', 'Espíritu emprendedor', '起業家精神', '企业家精神'),
                             'image' => '/media/video/our-expertise-hero-poster.jpg', 'icon' => 'bulb',
                            ...
                            ['title' => $this->loc('Transparency, Collaboration & Teamwork', 'Transparencia, colaboración y trabajo en equipo', '透明性・協働・チームワーク', '透明、协作与团队精神'),
                             'image' => '/media/impact/mangroves.jpg', 'icon' => 'handshake',
                            ...
                            ['title' => $this->loc('Social Responsibility', 'Responsabilidad social', '社会的責任', '社会责任'),
                             'image' => '/media/impact/education.jpg', 'icon' => 'leaf',
                            ...
                            ['title' => $this->loc('Customer Centricity', 'Centrados en el cliente', '顧客中心', '以客户为中心'),
                             'image' => '/media/company/head-office.jpg', 'icon' => 'heart',
                ...
                ['key' => 'presence', 'type' => 'map', 'blocks' => [
                    ['map', [
                        ...
                        // lat/lon plot each site at its surveyed position. Colombo
                        // and Trincomalee sit ~6px apart at world scale and so read
                        // as one dot on Sri Lanka; the region list beside the map is
                        // what distinguishes them. Moving a pin off its real
                        // coordinates to separate them is not a trade worth making.
                        'items' => [
        ...
        return [
            ...
            'sections' => [
                ...
                ['key' => 'categories', 'type' => 'categories', 'blocks' => [
                    ...
                    // Each category opens its full look-book, hosted on Adobe Express.
                    ['portfolio_grid', [
                        'eyebrow' => $this->loc('Product portfolio', 'Portafolio de producto', '製品ポートフォリオ', '产品组合'),
                        'title'   => $this->loc('Explore the full portfolios', 'Explora los portafolios completos', 'ポートフォリオ一覧', '浏览完整作品集'),
                        'intro'   => $this->loc('Open any category to view its complete look-book.',
                            'Abre cualquier categoría para ver su look-book completo.',
                            '各カテゴリーを開くと、ルックブック全体をご覧いただけます。',
                            '点击任一类别，查看完整的产品图册。'),
                        'items' => [
                            ['name' => $this->loc('Babywear', 'Ropa de bebé', 'ベビーウェア', '婴儿装'),
                             'image' => '/media/showroom/categories/babywear.jpg',
                             'url' => 'https://new.express.adobe.com/webpage/wviIrBXYkUbec'],
                            ['name' => $this->loc('Childrenswear', 'Ropa infantil', 'チルドレンウェア', '童装'),
                             'image' => '/media/showroom/categories/childrenswear.jpg',
                             'url' => 'https://new.express.adobe.com/webpage/XLD2sKU3mbaiI'],
                            ['name' => $this->loc('Kids’ Nightwear', 'Pijamas infantiles', 'キッズナイトウェア', '儿童睡衣'),
                             'image' => '/media/showroom/categories/kids-nightwear.jpg',
                             'url' => 'https://express.adobe.com/page/IMs8kefOQ5HjU/'],
                            ['name' => $this->loc('School Wear', 'Uniformes escolares', 'スクールウェア', '校服'),
                             'image' => '/media/showroom/categories/school-wear.jpg',
                             'url' => 'https://express.adobe.com/page/EhmXhjt5dW6K8'],
                            ['name' => $this->loc('Accessories, True Knits, Hosiery & Toys', 'Accesorios, tejidos de punto, calcetería y juguetes', 'アクセサリー・ニット・ホーザリー・トイ', '配饰、针织、袜类与玩具'),
                             'image' => '/media/showroom/categories/hosiery-toys.jpg',
                             'url' => 'https://express.adobe.com/page/U5v8hKzqdxS1B/'],
                            ['name' => $this->loc('Adults — Woven', 'Adultos — Tejido plano', 'アダルト — 織物', '成人梭织'),
                             'image' => '/media/showroom/categories/adults-woven.jpg',
                             'url' => 'https://new.express.adobe.com/webpage/iQeI6VsPqn9HC'],
                            ['name' => $this->loc('Adults — Jersey', 'Adultos — Punto', 'アダルト — ジャージー', '成人针织'),
                             'image' => '/media/showroom/categories/adults-jersey.jpg',
                             'url' => 'https://express.adobe.com/page/zjVmPosAWVSaq/'],
                            ['name' => $this->loc('Activewear', 'Ropa deportiva', 'アクティブウェア', '运动装'),
                             'image' => '/media/showroom/categories/activewear.jpg',
                             'url' => 'https://express.adobe.com/page/wzyzSvEA5FIg5'],
                            ['name' => $this->loc('Maternity', 'Maternidad', 'マタニティ', '孕妇装'),
                             'image' => '/media/showroom/categories/maternity.jpg',
                             'url' => 'https://new.express.adobe.com/webpage/ag4HqAErboIcF'],
                            ['name' => $this->loc('Adults’ Essentials & Nightwear', 'Básicos y ropa de dormir', 'アダルト エッセンシャル・ナイトウェア', '成人基础款与睡衣'),
                             'image' => '/media/showroom/categories/adults-essentials.jpg',
                             'url' => 'https://new.express.adobe.com/webpage/dh4t9XHT7x1AW'],
                        ],
                    ]],
                ]],
