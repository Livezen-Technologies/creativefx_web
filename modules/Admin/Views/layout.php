...
$groups = [
    ['Overview', [
        ...
        ['analytics', 'Analytics', 'admin/analytics', 'chart'],
    ]],
    ['Catalogue', [
        ['courses', 'Courses', 'admin/courses', 'box'],
        ['course-categories', 'Categories', 'admin/course-categories', 'tag'],
        ['course-sessions', 'Dates & seats', 'admin/course-sessions', 'clock'],
        ['bundles', 'Programmes', 'admin/bundles', 'cube'],
        ['instructors', 'Instructors', 'admin/instructors', 'users'],
        ['venues', 'Venues', 'admin/venues', 'pin'],
    ]],
    ['Selling', [
    ...
    ['Content', [
        ...
        ['news-posts', 'Articles', 'admin/news-posts', 'news'],
        ['news-categories', 'Article categories', 'admin/news-categories', 'tag'],
        ['resources', 'Free resources', 'admin/resources', 'download'],
        ['webinars', 'Webinars', 'admin/webinars', 'video'],
        ['menu-items', 'Navigation menus', 'admin/menu-items', 'menu'],
        ['videos', 'Video', 'admin/videos', 'video'],
    ]],
    ['The public', [
        ['contacts', 'Contact inbox', 'admin/contacts', 'mail'],
        ['leads', 'General leads', 'admin/leads', 'target'],
        ['jobs', 'Vacancies', 'admin/jobs', 'briefcase'],
        ['applications', 'Job applications', 'admin/applications', 'users'],
    ]],
    ['System', [
...
<head>
    ...
    <title><?= esc($title ?? 'Admin') ?> — <?= esc(setting('site_name', '')) ?> Admin</title>
