...
class CareersSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $jobs = [
            ...
            [
                'slug' => 'software-engineer-digital',
                'title' => $j(['en' => 'Software Engineer — Digital Core', 'es' => 'Ingeniero de Software']),
                'description' => $j(['en' => "Build and integrate the systems behind our digital strategy — ERP integrations, vendor and quality management portals, dashboards and automation across the supply chain."]),
                'department' => 'IT', 'country' => 'Sri Lanka', 'location' => 'Colombo (hybrid)',
                'employment_type' => 'full-time', 'experience' => '2+ years in software engineering',
                'qualifications' => $j(['Degree in computer science or equivalent experience', 'Experience with PHP/SQL or a modern web stack', 'ERP/SAP integration experience an advantage']),
                'skills' => $j(['PHP', 'MySQL', 'APIs', 'JavaScript', 'SAP integration']),
                'salary_range' => null, 'status' => 'open', 'posted_at' => $now,
            ],
            [
                'slug' => 'merchandiser-tirupur',
                'title' => $j(['en' => 'Senior Merchandiser — India', 'es' => 'Comercializador Sénior — India']),
                'description' => $j(['en' => 'Lead customer accounts for Norlanka Manufacturing India, coordinating our Tirupur and Delhi partner factories for woven and jersey programmes.']),
                'department' => 'Merchandising', 'country' => 'India', 'location' => 'Tirupur',
                'employment_type' => 'full-time', 'experience' => '5+ years in apparel merchandising',
                'qualifications' => $j(['Degree in textiles/apparel or related field', 'Track record managing international accounts end-to-end']),
                'skills' => $j(['Account management', 'Woven & jersey', 'Negotiation', 'Vendor management']),
                'salary_range' => null, 'status' => 'open', 'posted_at' => $now,
            ],
            [
